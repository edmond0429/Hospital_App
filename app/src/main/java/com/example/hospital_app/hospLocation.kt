...
import kotlinx.android.synthetic.main.activity_hosp_location.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class hospLocation : AppCompatActivity(), OnMapReadyCallback, PermissionsListener, MapboxMap.OnMapClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hosp_location)

        val mapView = findViewById<MapView>(R.id.mapView)
        val btnStart = findViewById<Button>(R.id.btnStart)
        val fab_location_search = findViewById<FloatingActionButton>(R.id.fab_location_search)
